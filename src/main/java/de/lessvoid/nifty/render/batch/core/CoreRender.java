...
public class CoreRender {
  ...
  /**
	 * Renders the currently active VAO using triangle strips with the specified
	 * number of vertices.
	 *
	 * @param gl    the gl
  ...
  /**
	 * Renders the currently active VAO using triangle fan with the specified number
	 * of vertices.
	 *
	 * @param gl    the gl
  ...
  /**
	 * Renders the currently active VAO using triangle strips with the specified
	 * number of vertices AND does that primCount times.
	 *
	 * @param gl        the gl
	 * @param count     The number of vertices to render as triangle strips per
	 *                  primitive.
  ...
  /**
	 * Renders the currently active VAO using triangle strips, sending the specified
	 * number of indices.
	 *
	 * @param gl    the gl
  ...
  /**
	 * Renders the currently active VAO using triangle fans, sending the specified
	 * number of indices.
	 *
	 * @param gl    the gl
  ...
  /**
	 * Renders the currently active VAO using triangles with the specified number of
	 * vertices.
	 *
	 * @param gl          the gl
  ...
  /**
	 * Renders the currently active VAO using points with the specified number of
	 * vertices.
	 *
	 * @param gl    the gl
  ...
  /**
	 * Renders the currently active VAO using points with the specified number of
	 * vertices AND does that primCount times.
	 *
	 * @param gl        the gl
