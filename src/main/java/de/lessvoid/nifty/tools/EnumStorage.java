...
/**
 * This is a special implementation for a enumeration based storage. It stores
 * values in relation to enum keys that are generated by a factory once they are
 * requested. This is handy in case the factory creates carrier objects that are
 * supposed to store data in relation to the enumeration keys.
 *
 * @author Martin Karing &lt;nitram@illarion.org&gt;
 * @param <K> the type of the keys, this has to be a enumeration
 * @param <V> the type of objects used as values, the factory has to generate
 *            those
 */
